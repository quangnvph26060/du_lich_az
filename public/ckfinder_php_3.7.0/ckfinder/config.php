...
$config['licenseName'] = 'base.test';
$config['licenseKey']  = 'YUYUKTCKC6NX8DLXN8GQ66J61KP9C';
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://dienmaysgo.test/storage/', // Đây là URL mà CKFinder sẽ sử dụng để truy cập các tệp tin
